...
#X_train_positive2, X_train_negative2 = loadData("../newDatasets/11_CLIPSEQ_ELAVL1_hg19/seq_test.fa")
#X_test_positive2, X_test_negative2 = loadData("../newDatasets/11_CLIPSEQ_ELAVL1_hg19/seq_train.fa")
...
model = Sequential()
model.add(Conv1D(140, kernel_size=2, activation='relu', input_shape=(100, 32)))
...
#model.fit(X_input_train, X_output_train, epochs=30)
